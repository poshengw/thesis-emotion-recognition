clc;    close all;   clear;
strTrainPath = 'C:\Users\michael\Desktop\new_step\EigenFace\ImageDataBase\IndMan\2_Delete_Ambituity\Train';
strLabelFile = 'LabelFile_Nov_TF.txt';
strTestPath = 'C:\Users\michael\Desktop\new_step\EigenFace\ImageDataBase\IndMan\2_Delete_Ambituity\Test';
...
for i = 1:numTestImage
    % Detect_Face 
    [Faces_crop] = FaceDetection(imresize(imread(TestImages{i,1}),[375,300]));
    aa = imresize(Faces_crop,imageSize);
    % Detect_Eyes
