function [aa]=FaceDetection(I,iteration)
...
disp(sprintf('Through FaceDetection'));

imwrite(aa,strcat('C:\Users\michael\Desktop\Auto_JapanDatabsed\ResultImage\CropFace\',['Image',num2str(iteration,'%03d'),'.jpg']));
